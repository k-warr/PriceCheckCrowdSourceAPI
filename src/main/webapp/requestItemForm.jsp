...
<br /><br />
<%--<form method="GET" action="http://localhost:8080/pricerequest/JSON/request">--%>
<form method="GET" action="http://52.14.136.34:8080/pricecheck/pricerequest/JSON/request">
    <fieldset>
